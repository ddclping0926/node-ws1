...
const UUID = process.env.UUID || '3c5f4cdd-4af7-4994-bd29-373c8b3095a2'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || '9mT4ZfLFLhXJgd2pVBuyySlsMt8Fr00r';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const SUB_PATH = process.env.SUB_PATH || 'ddcl';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'railwayB';                       // 节点名称
